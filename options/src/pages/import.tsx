...
const importMethods = [
  { name: 'Import secret recovery phrase', icon: KeyIcon, description: 'Import accounts from another wallet', color: 'from-purple-500 to-pink-500' },
  { name: 'Import private key', icon: LockIcon, description: 'Import a single-chain account', color: 'from-blue-500 to-teal-500' },
];
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="flex-grow">
                      <h3 className="text-lg font-semibold text-white group-hover:text-white transition-colors duration-300">{method.name}</h3>
                      <p className="text-sm text-gray-400 group-hover:text-gray-200 transition-colors duration-300">{method.description}</p>
                    </div>
          ...
          <>
            ...
            {walletAddress && (
              <div className="mt-4">
                ...
                <p className={`mt-1 text-sm ${walletAddress === 'Invalid Format' ? 'text-red-500' : 'text-green-500'}`}>{walletAddress}</p>
              </div>
            )}
            <Button
